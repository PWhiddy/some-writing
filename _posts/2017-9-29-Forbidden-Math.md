...
Suppose we have the hyperoperator function that takes two arguements:  
...
$$h_{2}(a,b)$$ multiplies $$a$$ and $$b$$. This equivilent to repeated addition.  
...
$$h_{4}(a,b)$$ is called tetration, and is equivilent to a stack of exponents with a height of $$b$$.  
...
Using the pattern layed out in the beginning, we can recursively define $$h_{n}$$ with repeated applications of $$h_{n-1}$$. It turns the final result can be expressed succinctly with a fold.  
...
It now becomes obvious the differences between these operators. For example, addition and multiplication are both assosiative and communitive, while exponentiation and higher are neither. 